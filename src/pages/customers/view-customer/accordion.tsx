...
const Accordion = ({ title, children, width }: { title: ReactNode; children: ReactNode; width?: string }) => {
  ...
  return (
    ...
    >
      <AccordionContainer style={{ maxHeight: isOpen ? "31.25rem" : "3.75rem", overflowY: isOpen ? "auto" : "hidden", overflowX: "hidden" }}>
